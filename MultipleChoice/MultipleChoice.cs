    ...
    public partial class MultipleChoice : Form
    {
        ...
        public void checkQuestions()
        {
            if (txtQuestion1.Text != "" & txtQuestion2.Text != "" & txtQuestion3.Text != "" & txtQuestion4.Text != "")
            {
                ...
                MessageBox.Show("Test has been successfully set and saved to file.", "setting completed", MessageBoxButtons.OK, MessageBoxIcon.Information);
                panelLecture.Visible = true;
                btnPastPaper.Visible = false;
            }
            else
...

            {
                ...
                txtUserAnswer4.Text
                    ...
                    if (studentMark != "")
                    {
                        ...
                        MessageBox.Show("Test was successfully completed and marked, please check the results and memo. The test and memo were successfully saved to file.", "Test completed", MessageBoxButtons.OK, MessageBoxIcon.Information);
